...
local EZ = loadstring(game:HttpGet("https://raw.githubusercontent.com/DexCodeSX/EZ/main/Library.lua"))()
...
sec:AddButton({
    Text = "Reload script",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/DexCodeSX/EZ/main/KeySystemTest.lua"))()
    end
})
